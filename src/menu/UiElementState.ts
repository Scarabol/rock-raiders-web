...
export class UiElementState {
    ...
    onPressed: UiElementCallback | undefined
    onHoverChanged: UiElementCallback | undefined
    onShowTooltip: UiElementCallback | undefined
    onHideTooltip: UiElementCallback | undefined
