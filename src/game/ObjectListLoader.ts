...
export class ObjectListLoader {
    ...
    private static loadObjectEntry(olEntry: ObjectListEntryCfg, sceneMgr: SceneManager, worldMgr: WorldManager, entityMgr: EntityManager, vehicleKeyToDriver: Map<string, Raider>, disableStartTeleport: boolean, vehicleByKey: Map<string, VehicleEntity>, olKey: string) {
